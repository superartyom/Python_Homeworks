...
for i in range(0, 3):
    ...
    lst_2.pop()  # Դատարկելու համար կարող ես ուղղակի գրել lst = []։ Էսպես պատկերացրու 100 երկարությամբ լիստ մաքրես :)
    lst_2.pop()
    lst_2.pop()
print(lst_1)
print('█' * 100)
...
lst_1 = [[num**2 for num in range (1, 4) ] for i in range(1, 4)]
print(lst_1)  # Պետք է 1-9 թվերի քառակուսիները լինեին։ Հիմա էսպես է ստացվում  [[1, 4, 9], [1, 4, 9], [1, 4, 9]]
print('█' * 100)
...
for char in nonsense:
    if char == 'b' or char == 'B':  # Կամ էլ մի արտահայտությամբ կարող ես գրել char.lower() == 'b'
        total += 1
print(total, '\n', '█' * 100, sep='')
